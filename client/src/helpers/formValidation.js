export function formValidation (inputs){
    ...
    if( inputs.nombre.length > 15 || inputs.nombre.length === 0) errors.nombre = 'El nombre debe tener entro 0 y 15 caracteres'
    //VIDA - ENTRE 0 Y 100
    if( inputs.vida > 100 || inputs.vida < 1) errors.vida = 'La vida debe ser un valor entre 1 y 100'
    //ATAQUE - ENTRE 0 Y 100
    if( inputs.ataque > 100 || inputs.ataque < 1) errors.ataque = 'El ataque debe ser un valor entre 1 y 100'
    //DEFENSA - ENTRE 0 Y 100
    if( inputs.defense > 100 || inputs.defensa < 1) errors.defensa = 'La defensa debe ser un valor entre 1 y 100'
